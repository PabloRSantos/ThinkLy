...
const alertDialogContentStyle = tva({
  ...
  variants: {
    action: {
      ...
      positive: "bg-background-success border-success-300",
...
const alertDialogBackdropStyle = tva({
  base: "absolute left-0 top-0 right-0 bottom-0 bg-background-dark/80 web:cursor-default",
});
...
>(function AlertDialogContent({ className, size, action, ...props }, ref) {
